...
export const createUserProfile = async (
    ...
    const responseBody: UserTranslationOkResponse = await JSON.parse(response.text);
    const {
        description, firstName,
        middleName, position, smallDescription,
        status, surnameName } = dto
    ...
    expect(responseBody.data).toHaveProperty('smallDescription', smallDescription);
...
export const userProfileF = async (
    app,
    data: fullSignUpType,
